...
void tSeventhFGPredel(void)
{
    ...
    {
        FGPredel = sin(x) / x;
        cout << "Predel " << setw(3) << setfill('0') << right << i << " : " << setw(10) << setfill('0') << setprecision(6) << FGPredel << " | ";
        cout << "x: " << left << setw(12) << setfill('0') << setprecision(6) << x << " | ";
        cout << "Equtation: " << setw(11) << setfill('0') << setprecision(6) << 1 - FGPredel << endl;
        x /= 2;
        i++;
...
void tEighthSGPredel(void)
{
    ...
    do
    {
        ...
        cout << "Predel : " << left << setw(10) << setfill('0') << setprecision(6) << SGPredel << " | ";
        cout << "Equtation: " << setw(11) << setfill('0') << setprecision(6) << fabs(M_E - SGPredel) << endl;
        n++;
